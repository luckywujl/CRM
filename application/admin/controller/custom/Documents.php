 ...
 * @icon fa fa-circle-o
 */
class Documents extends Backend
{
    
    /**
     * Documents模型对象
     * @var \app\admin\model\custom\Documents
     */
    protected $model = null;
    protected $dataLimit = 'personal';
    protected $dataLimitField = 'company_id';
    protected $dataCreateField = 'admin_id';
    protected $searchFields = 'custom_documents_name';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\custom\Documents;
