...
class Bill extends Backend
{
    ...
    /**
     * Bill模型对象
     * @var \app\admin\model\custom\Bill
     */
    protected $model = null;
    protected $dataLimit = 'personal';
    protected $dataLimitField = 'company_id';
    protected $dataCreateField = 'admin_id';
    protected $searchFields = 'custom_bill_content';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\custom\Bill;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $total = $this->model
                ...
                ->where($where)
					 ->where('bill.custom_id',$params['custom_id'])
