...
class Purpose extends Backend
{
    ...
    /**
     * Purpose模型对象
     * @var \app\admin\model\custom\Purpose
     */
    protected $model = null;
    protected $dataLimit = 'personal';
    protected $dataLimitField = 'company_id';
    protected $dataCreateField = 'admin_id';
    protected $searchFields = 'custom_purpose_product';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\custom\Purpose;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $total = $this->model
                ...
                ->where($where)
					 ->where('purpose.custom_id',$params['custom_id'])
