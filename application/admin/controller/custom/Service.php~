...
class Service extends Backend
{
    ...
    /**
     * Service模型对象
     * @var \app\admin\model\custom\Service
     */
    protected $model = null;
    protected $dataLimit = 'personal';
    protected $dataLimitField = 'company_id';
    protected $dataCreateField = 'admin_id';
    protected $searchFields = 'custom_service_content';


    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\custom\Service;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $total = $this->model
                ...
                ->where($where)
					 ->where('service.custom_id',$params['custom_id'])
