 ...
 * @icon fa fa-circle-o
 */
class Ddetail extends Backend
{
    
    /**
     * Ddetail模型对象
     * @var \app\admin\model\custom\Ddetail
     */
    protected $model = null;
    protected $dataLimit = 'personal';
    protected $dataLimitField = 'company_id';
    protected $dataCreateField = 'admin_id';
    protected $searchFields = 'custom_ddetail_product';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\custom\Ddetail;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $total = $this->model
                ...
                ->where($where)
					 ->where('ddetail.custom_id',$params['custom_id'])
