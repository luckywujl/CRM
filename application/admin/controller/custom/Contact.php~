...
class Contact extends Backend
{
    ...
    /**
     * Contact模型对象
     * @var \app\admin\model\custom\Contact
     */
    protected $model = null;
    protected $dataLimit = 'personal';
    protected $dataLimitField = 'company_id';
    protected $dataCreateField = 'admin_id';
    protected $searchFields = 'custom_contact_name';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\custom\Contact;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $total = $this->model
                ...
                ->where($where)
					 ->where('contact.custom_id',$params['custom_id'])
