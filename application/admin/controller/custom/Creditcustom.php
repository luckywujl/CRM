 ...
 * @icon fa fa-circle-o
 */
class Creditcustom extends Backend
{
    
    /**
     * Creditcustom模型对象
     * @var \app\admin\model\custom\Creditcustom
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\custom\Creditcustom;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax())
        {
            ...
            $total = $this->model
                    ...
                    ->where($where)
                    ->where('creditcustom.custom_admin',$this->auth->id)
                    ->order($sort, $order)
                    ->count();
