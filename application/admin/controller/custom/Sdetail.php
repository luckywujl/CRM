 ...
 * @icon fa fa-circle-o
 */
class Sdetail extends Backend
{
    
    /**
     * Sdetail模型对象
     * @var \app\admin\model\custom\Sdetail
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\custom\Sdetail;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $total = $this->model
                ...
                ->where($where)
					 ->where('sdetail.custom_id',$params['custom_id'])
