...
--
-- Table structure for table `crm_ems`
--

DROP TABLE IF EXISTS `crm_ems`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `crm_ems` (
...
--
-- Dumping data for table `crm_ems`
--

LOCK TABLES `crm_ems` WRITE;
/*!40000 ALTER TABLE `crm_ems` DISABLE KEYS */;
/*!40000 ALTER TABLE `crm_ems` ENABLE KEYS */;
UNLOCK TABLES;
