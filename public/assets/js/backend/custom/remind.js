define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'custom/remind/index' + location.search,
                    add_url: 'custom/remind/add',
                    edit_url: 'custom/remind/edit',
                    del_url: 'custom/remind/del',
                    multi_url: 'custom/remind/multi',
                    table: 'custom_remind',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'custom/remind/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
