<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"/home/www/admin/localhost_9001/wwwroot/public/../application/admin/view/custom/payment/edit.html";i:1614729562;s:81:"/home/www/admin/localhost_9001/wwwroot/application/admin/view/layout/default.html";i:1588765310;s:78:"/home/www/admin/localhost_9001/wwwroot/application/admin/view/common/meta.html";i:1588765310;s:80:"/home/www/admin/localhost_9001/wwwroot/application/admin/view/common/script.html";i:1588765310;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-custom_payment_paytime" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[custom_payment_paytime]" type="text" value="<?php echo $row['custom_payment_paytime']?datetime($row['custom_payment_paytime']):''; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Custom_payment_content'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-custom_payment_content" class="form-control" name="row[custom_payment_content]" type="text" value="<?php echo htmlentities($row['custom_payment_content']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Custom_payment_account'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-custom_payment_account" class="form-control" name="row[custom_payment_account]" type="number" value="<?php echo htmlentities($row['custom_payment_account']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Custom_payment_bidding'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-custom_payment_bidding" class="form-control" name="row[custom_payment_bidding]" type="text" value="<?php echo htmlentities($row['custom_payment_bidding']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Custom_payment_handler'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-custom_payment_handler" class="form-control" name="row[custom_payment_handler]" type="text" value="<?php echo htmlentities($row['custom_payment_handler']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-custom_payment_person" class="form-control" name="row[custom_payment_person]" type="text" value="<?php echo htmlentities($row['custom_payment_person']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Custom_payment_remark'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-custom_payment_remark" class="form-control " rows="5" name="row[custom_payment_remark]" cols="50"><?php echo htmlentities($row['custom_payment_remark']); ?></textarea>
        </div>
    </div>
