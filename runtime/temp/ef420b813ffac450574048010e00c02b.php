<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"/home/www/admin/localhost_9001/wwwroot/public/../application/admin/view/custom/mycustom/edit.html";i:1614643262;s:81:"/home/www/admin/localhost_9001/wwwroot/application/admin/view/layout/default.html";i:1588765310;s:78:"/home/www/admin/localhost_9001/wwwroot/application/admin/view/common/meta.html";i:1588765310;s:80:"/home/www/admin/localhost_9001/wwwroot/application/admin/view/common/script.html";i:1588765310;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-1 col-sm-1">
            <input id="c-company" data-rule="required" readonly="readonly" class="form-control" name="company" type="text" value="<?php echo $auth_id; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-1 col-sm-1">
            <input id="c-custom_payable_total" readonly="readonly" class="form-control" name="row[custom_payable_total]" type="text" value="<?php echo htmlentities($row['custom_payable_total']); ?>">
        </div>
    </div>
    <div class="form-group">
